...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-cta { display: none; padding: .8rem 1.5rem; border-radius: var(--rp); border: 1.5px solid var(--glh); font-size: .75rem; font-weight: 700; letter-spacing: .06em; text-transform: uppercase; color: var(--g2); transition: background .3s, color .3s, border-color .3s, transform .25s; }
